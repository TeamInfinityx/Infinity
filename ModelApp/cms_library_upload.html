<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeFile="cms_library_upload.aspx.cs" Inherits="bim_upload_bim_upload" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <div id="MainContainer">
         <div id="UploadContainer">
            ...
            <div style="color:green;font-size:18px;"><span>Upload 3D Library.</span></div>
            ...
            <div style="padding-left: 0px;padding-top: 10px;">
                ...
                <!--<input   class="form-control" id="file1" name = "file1" type="file" />--->
                 ...
                 <asp:Button style="margin-top:5px;" class="btn btn-primary" id="Uploadbtn" runat="server" Text="Upload"  OnClick="UploadBimModel"/>
            </div>
             <div id="loader" class="col-xs-12" style="margin-top:20px;padding-left:0px;font-size:16px;display:none"><img style="width:40px;height:40px;" src="assets/loader.gif" /> <span>Uploading...</span></div>
         </div>
         <div id="updateContainer">
             <iframe src="cms_library_update.aspx?eid=<%=enterpriseId %>&pid=<%=projectId %>&uid=<%=userId %>&uk=<%=userKey %>"></iframe>
         </div>
    </div>
    </form>
    ...
    <script>
        ...
        if (flag==1) {
            ...
            $("#data-frame").attr("src",'library_model_data_collect.aspx?eid='+enterpriseid+'&pid='+projectid+'&uid='+userid+'&uk='+userkey+'&flag='+dataCollectFlag+'&libid='+libraryId+'')
        }
        function libraryupdateCmplt(libId){
            $("#UploadContainer").hide();
            $(".full-frame-holder").show();
            $("#data-frame").attr("src",'library_model_data_collect.aspx?eid='+enterpriseid+'&pid='+projectid+'&uid='+userid+'&uk='+userkey+'&flag=0&libid='+libId+'&isupdate=1')
        }
